...
CONTAINS
  SUBROUTINE xios_set_axisgroup_attr &
    ( axisgroup_id, bounds, group_ref, long_name, name, positive, size, standard_name, unit, value &
    , zoom_begin, zoom_end, zoom_size )
    IMPLICIT NONE
      ...
      CALL xios_get_axisgroup_handle(axisgroup_id,axisgroup_hdl)
      CALL xios_set_axisgroup_attr_hdl_ &
      ( axisgroup_hdl, bounds, group_ref, long_name, name, positive, size, standard_name, unit, value &
      , zoom_begin, zoom_end, zoom_size )
  ...
  SUBROUTINE xios_set_axisgroup_attr_hdl_ &
    ( axisgroup_hdl, bounds_, group_ref_, long_name_, name_, positive_, size_, standard_name_, unit_ &
    , value_, zoom_begin_, zoom_end_, zoom_size_ )
    IMPLICIT NONE
      TYPE(xios_axisgroup) , INTENT(IN) :: axisgroup_hdl
