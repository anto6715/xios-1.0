...
CONTAINS
  SUBROUTINE xios_set_filegroup_attr &
    ...
    IMPLICIT NONE
      ...
      CALL xios_get_filegroup_handle(filegroup_id,filegroup_hdl)
  ...
  SUBROUTINE xios_set_filegroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(time_counter_)) THEN
        CALL cxios_set_filegroup_time_counter(filegroup_hdl%daddr, time_counter_, len(time_counter_))
      ENDIF
  ...
  SUBROUTINE xios_get_filegroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
      IF (PRESENT(time_counter_)) THEN
        CALL cxios_get_filegroup_time_counter(filegroup_hdl%daddr, time_counter_, len(time_counter_))
      ENDIF
      IF (PRESENT(type_)) THEN
  ...
  SUBROUTINE xios_is_defined_filegroup_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
      IF (PRESENT(time_counter_)) THEN
        time_counter__tmp=cxios_is_defined_filegroup_time_counter(filegroup_hdl%daddr)
