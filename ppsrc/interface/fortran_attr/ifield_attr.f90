...
CONTAINS
  SUBROUTINE xios_set_field_attr &
    ( field_id, add_offset, axis_ref, compression_level, default_value, detect_missing_value, domain_ref &
    , enabled, field_ref, freq_offset, freq_op, grid_ref, level, long_name, name, operation, prec &
    ...
    IMPLICIT NONE
      ...
      ( field_hdl, add_offset, axis_ref, compression_level, default_value, detect_missing_value, domain_ref &
      , enabled, field_ref, freq_offset, freq_op, grid_ref, level, long_name, name, operation, prec &
      , scale_factor, standard_name, unit, valid_max, valid_min )
  ...
  SUBROUTINE xios_set_field_attr_hdl_ &
    ( field_hdl, add_offset_, axis_ref_, compression_level_, default_value_, detect_missing_value_ &
    , domain_ref_, enabled_, field_ref_, freq_offset_, freq_op_, grid_ref_, level_, long_name_, name_ &
    ...
    IMPLICIT NONE
      ...
      IF (PRESENT(compression_level_)) THEN
        CALL cxios_set_field_compression_level(field_hdl%daddr, compression_level_)
      ENDIF
  ...
  SUBROUTINE xios_get_field_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
      IF (PRESENT(compression_level_)) THEN
        CALL cxios_get_field_compression_level(field_hdl%daddr, compression_level_)
      ENDIF
      IF (PRESENT(default_value_)) THEN
  ...
  SUBROUTINE xios_is_defined_field_attr_hdl_ &
    ...
    IMPLICIT NONE
      ...
      ENDIF
      IF (PRESENT(compression_level_)) THEN
        compression_level__tmp=cxios_is_defined_field_compression_level(field_hdl%daddr)
