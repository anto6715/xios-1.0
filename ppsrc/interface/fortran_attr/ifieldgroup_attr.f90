...
CONTAINS
  SUBROUTINE xios_set_fieldgroup_attr &
    ...
    , domain_ref, enabled, field_ref, freq_offset, freq_op, grid_ref, group_ref, level, long_name &
    , name, operation, prec, scale_factor, standard_name, unit, valid_max, valid_min )
    IMPLICIT NONE
      ...
      CALL xios_get_fieldgroup_handle(fieldgroup_id,fieldgroup_hdl)
  ...
  SUBROUTINE xios_set_fieldgroup_attr_hdl_ &
    ...
    , domain_ref_, enabled_, field_ref_, freq_offset_, freq_op_, grid_ref_, group_ref_, level_, long_name_ &
